...
def launch_all_isos(base, max_dim, recursion_parameter = None, output_type = 'file in results'):
    ...
    try:
        ...
        if output_type == 'file in results':
            ...
            if re.search('Functor name: Szymczak', result) is not None:
                output_txt = f'../results/szymczak_all_isos/txt/dim{max_dim}/Z{base}-dim-{max_dim}'
